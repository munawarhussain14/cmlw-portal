...
use App\Http\Requests\TopPositionScholarshipRequest;
use DB;
use App\Helper\DatatableHelper;
use Auth;
use App\Traits\ActionTrait;

class TopPositionScholarshipController extends AdminController
{
    use ActionTrait;

    private $params = [
        "basic" => "admin/scholarships/top-position",
        "dir" => "admin.scholarships.top-position",
        "route" => "admin.scholarships.top-position",
        "model" => "top_position",
        "singular_title" => "Quality Education",
        "plural_title" => "Quality Education",
        "module_name" => "top-position",
        "upload_dir" => "top-position",
        "columns" => [
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(TopPositionScholarshipRequest $request)
    {
        $data = [];
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(TopPositionScholarshipRequest $request, $id)
    {
        $data = [];
