...
<div class="row mb-2">
    <div class="col-6">
        ...
        <form class="d-inline" action="{{ route($params['route'] . '.status', ['id' => $row->id]) }}" method="post"
        ...
        @endcan
        @endif
        <a target="_blank" href="{{ route($params['route'] . '.edit', ['compilation' => $row->id]) }}"
            class="btn btn-success d-inline"><i class="fa fa-pencil"></i> Edit</a>
    </div>
