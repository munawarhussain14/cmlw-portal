...
@section('content')
    <div class="row">
        @can('deceased-grant-status')
            <div class="col-12">
                @include('admin.grants.partials.actionDeceasedTab', ['data' => $row])
            </div>
        @endcan
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-header-actions">
                        @can('update-deceased-mine-labour')
                            <a href="{{ route('admin.grants.deceased-mine-labour.edit', ['deceased_mine_labour' => $row->id]) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <p class="form-control">{{ $row->labour->father_cnic }}</p>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <p class="form-control">{{ $row->labour->mother_name }}</p>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <p class="form-control">{{ $row->labour->mother_cnic }}</p>
        ...
        <div class="col-12">
            @include('admin.component.wife.wife', ['wife' => $row->labour->wife])
        </div>
        <div class="col-12">
