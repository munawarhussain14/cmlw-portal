            ...
            <div class="row">
                ...
                <div class="col-12">
                    @include('admin.layouts.partials.filter', [
                        'url' => route('admin.grants.export-deceased-labour', ['scheme' => request()->type]),
                        'columns' => [
                            ['label' => 'ID', 'value' => 'death_grants.id', 'checked' => true],
                            ...
                            [
                                'label' => 'Wife Name',
                                'value' => 'labour_wife.name as wife_name',
                                'checked' => true,
                            ],
                            [
                                'label' => 'Wife CNIC',
                                'value' => 'labour_wife.cnic as wife_cnic',
                                'checked' => true,
                            ],
                            [
                            ...
                            ['label' => 'Fy Year', 'value' => 'death_grants.fy_year'],
