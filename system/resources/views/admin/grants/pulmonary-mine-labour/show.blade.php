...
@section('content')
    <div class="row">
        @can('pulmonary-grant-status')
            <div class="col-12">
                @include('admin.grants.partials.actionPulmonaryTab', ['data' => $row])
            </div>
        @endcan
        <div class="col-12">
            <div class="card card-primary">
                <div class="card-header">
                    ...
                    <div class="card-header-actions">
                        @can('update-pulmonary-mine-labour')
                            <a href="{{ route('admin.grants.pulmonary-mine-labour.edit', ['pulmonary_mine_labour' => $row->id]) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <p class="form-control">{{ $row->from_date }}</p>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <p class="form-control">{{ $row->to_date }}</p>
                            </div>
                        </div>
