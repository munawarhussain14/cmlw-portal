...
@section('content')
    <div class="row">
        @can('general-scholarship-app-status')
            <div class="col-12">
                @include('admin.scholarships.partials.appStatus', ['data' => $row])
            </div>
        @endcan
        @can('general-scholarship-action')
            <div class="col-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-header-actions">
                                @can('update-scholarships')
                                    <a href="{{ route('admin.scholarships.general.edit', ['general' => $row->id]) }}"
                                        target="_blank" class="card-header-action">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    &nbsp;|&nbsp;
                                @endcan
                                <a href="https://app.cmlw.gkp.pk/scholarship/general/print/{{ $row->s_id }}"
