...
@section('content')
    <div class="row">
        @can('quality-education-app-status')
            <div class="col-12">
                @include('admin.scholarships.partials.appStatus', ['data' => $row])
            </div>
        @endcan
        <div class="col-12">
            @can('quality-education-scholarship-action')
                @include('admin.scholarships.partials.actionTab', ['data' => $row])
            @endcan
        </div>
        <div class="col-12">
            <div class="row">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-header-actions">
                                @can('update-quality-education')
                                    <a href="{{ route('admin.scholarships.quality-education.edit', ['quality_education' => $row->id]) }}"
                                        target="_blank" class="card-header-action">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    &nbsp;|&nbsp;
                                @endcan
                                <a href="https://app.cmlw.gkp.pk/scholarship/general/print/{{ $row->id }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="marks-container hide">
                                        <div class="row marks">
                                            <div class="col-lg-12 covid">
                                                <br>
                                                <h5 class="section-title">
                                                    <div class="row">
                                                        <div class="col-sm-6 col-6">
                                                            <span class="english">Please provide your <span
                                                                    style="color:red;"><span class="result-class">Previous
                                                                        Class/Semester</span>
                                                                    Result</span>
                                                                and Passing Year</span>
                                                        </div>
                                                        <div class="col-sm-6 col-6 urdu">
                                                            <span class="urdu">
                                            ...
                                            <div class="col-md-4 top-position">
                                                @include('admin.layouts.partials.form.field', [
                                                    'label' => 'Roll No',
                                                    'value' => $row->roll_no,
                                                    'id' => 'roll_no',
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-6 col-6">
                                                <label class="english">
                                                    Did you apply for any other Scholarship Scheme in other
        ...
        <div class="col-12">
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="row">
                        @foreach ($row->student->history as $item)
                            <div class="col-12">
                                <div class="row">
