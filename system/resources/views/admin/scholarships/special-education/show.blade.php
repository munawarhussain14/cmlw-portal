...
@section('content')
    <div class="row">
        @can('special-education-app-status')
            <div class="col-12">
                @include('admin.scholarships.partials.appStatus', ['data' => $row])
            </div>
        @endcan
        <div class="col-12">
            @can('special-education-scholarship-action')
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-header-actions">
                                @can('update-special-education')
                                    <a href="{{ route('admin.scholarships.special-education.edit', ['special_education' => $row->id]) }}"
                                        target="_blank" class="card-header-action">
                                        <i class="fa fa-edit"></i> Edit
                                    </a>
                                    &nbsp;|&nbsp;
                                @endcan
                                <a href="https://app.cmlw.gkp.pk/scholarship/special-education/print/{{ $row->s_id }}"
                        ...
                        <div class="card-body">
                            ...
                            <div class="row disability_factor">

                                <div class="col-12">
                                    @include('admin.layouts.partials.form.field', [
                                        'label' => 'Disability type',
                                        'value' => ucwords($row->student->disability_factor),
                                        'id' => 'disability_factor',
                                    ])
                                </div>
