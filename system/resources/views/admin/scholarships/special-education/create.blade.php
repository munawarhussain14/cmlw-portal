            ...
            <div class="card card-primary">
                ...
                <form id="data-form"
                    ...
                    <div class="card-body">
                        ...
                        <div class="row disability_factor" style="border:1px solid black; border-radius: 8px;">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-12 col-12">
                                            <label class="english">
                                                Please select the disability type<span class="required">*</span>
                                            </label>
                                            <label class="urdu">
                                                <span class="required">*</span>
                                                براہ کرم معذوری کی قسم منتخب کریں
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input position-static"
                                                    {{ old('disability_factor', $row->student->disability_factor) == 'deaf' ? 'checked' : '' }}
                                                    name="disability_factor" type="radio" value="deaf">
                                                Deaf and Dumb
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-check">
                                                <input class="form-check-input position-static"
                                                    {{ old('disability_factor', $row->student->disability_factor) == 'blind' ? 'checked' : '' }}
                                                    name="disability_factor" type="radio" value="blind">
                                                Blind
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-check">
                                                <input class="form-check-input position-static"
                                                    {{ old('disability_factor', $row->student->disability_factor) == 'mentally disabled' ? 'checked' : '' }}
                                                    name="disability_factor" type="radio" value="mentally disabled">
                                                Mentally Disabled
                                            </div>
                                        </div>
                                    </div>

                                    @error('disability_factor')
                        ...
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    ...
                                    Yes/ <span class="urdu">جی ہاں</span>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input position-static"
